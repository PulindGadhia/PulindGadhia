...
ROWS = [
    ...
    ("kv", "Name", "Pulind Gadhia"),
    ("kv", "Role", "AI & ML Student"),
    ("kv", "University", "Marwadi University"),
    ("kv", "Location", "Rajkot, Gujarat"),
    ...
    ("kv", "AI / ML", "TensorFlow • Scikit-learn • OpenCV"),
    ("kv", "GenAI", "OpenAI • Gemini • LangChain"),
    ("kv", "Cloud", "Google Cloud • AWS"),
    ...
    ("bul", "Building Qyverion"),
    ("bul", "AI & ML Student"),
    ("bul", "Google Cloud Skill Boost"),
    ("bul", "Hackathon Participant"),
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">pulind@github:~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">pulind</tspan><tspan fill="{MUTED}">@</tspan>'
