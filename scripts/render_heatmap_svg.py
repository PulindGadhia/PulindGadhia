...
""".strip()
    ...
    for wi, wname in [(1, "Mon"), (3, "Wed"), (5, "Fri")]:
        ...
        parts.append(f'<text x="{PAD}" y="{y:.1f}" fill="{MUTED}" font-size="11" font-weight="600">{wname}</text>')
    ...
    for ci, column in enumerate(grid):
        ...
        for ri, cell in enumerate(column):
            ...
            parts.append(
                f'<rect class="c" x="{gx}" y="{gy}" width="{CELL}" height="{CELL}" rx="3.5" '
